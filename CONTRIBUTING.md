...
このリポジトリは、初心者向けの公開フローを保ちながら、runtime を `commands/` と `templates/mysk/*.md` に絞ることを重視しています。変更前に [README.md](README.md)、[docs/workflow.md](docs/workflow.md)、[CLAUDE.md](CLAUDE.md) を確認してください。
...
- なぜ公開面を変える必要があるのか
- 初心者向けの使い方が簡単になっているか
- public command と top-level template の整合性が壊れていないか
...
| public template / archive | `docs/implementation-survey.md`, `docs/testing.md` |
